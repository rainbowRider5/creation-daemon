...
program
  .name('cc')
  .description('creation-daemon — orchestration layer that turns a single developer into a team')
  .version('0.1.0');

program
  .command('init')
  .description('Scaffold creation-daemon into the current project')
  .action(initCommand);
